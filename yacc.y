...
class_h: CLASS ID SEMI_COLUMN	{cout << "class_h: CLASS ID SEMI_COLUMN\n";}//class X :
		...
		{cout << "class_h: CLASS ID OPEN_S CLOSE_S SEMI_COLUMN\n";}
...
expr_list:	expr_list COMMA expr	{cout<<"expr_list: expr_list COMMA expr\n";}
			|expr %prec stmt_1	{cout<<"expr_list: expr %prec stmt_1\n";}
;				
...
block_stmt:  stmt_list END	{cout<<"block_stmt:	stmt_list END/n";}
	;
...
for_header: FOR target_list IN expr_list SEMI_COLUMN	{cout<<"for_header: FOR target_list IN expr_list SEMI_COLUMN/n";}
			|FOR ID COMMA ID IN expr_list SEMI_COLUMN	{cout<<"for_header:	FOR ID COMMA ID IN expr_list SEMI_COLUMN/n";}
			|FOR ID IN expr_list SEMI_COLUMN {cout<<"for_header:	FOR ID IN expr_list SEMI_COLUMN/n";}
...
assignment_stmt:	target_list ASSIGN expr_list 	{cout<<"assignment_stmt:	target_list EQUAL expr_list/n";}
					|ID COMMA ID ASSIGN expr_list 	{cout<<"assignment_stmt:	ID COMMA ID EQUAL expr_list/n";}
					|ID ASSIGN expr_list 	{cout<<"assignment_stmt:	ID EQUAL expr_list/n";}
					|target_list ASSIGN yield_expression	{cout<<"assignment_stmt:	target_list EQUAL yield_expression/n";}
					|ID COMMA ID ASSIGN yield_expression	{cout<<"assignment_stmt:	ID COMMA ID EQUAL yield_expression/n";}
					|ID ASSIGN yield_expression	{cout<<"assignment_stmt:	ID EQUAL yield_expression/n";}
;
...
atom:		 enclosure	{cout<<"atom:	enclosure/n";}
;
...
expr:	condition 	{cout<<"expr:	condition\n";}
		|literal %prec stmt_9	{cout<<"expr:	literal\n";}
...
long_id: ID	%prec stmt_8				{cout<<"long_id:	\n";}
